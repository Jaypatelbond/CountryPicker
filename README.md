...
dependencies {
    // For Jetpack Compose
    implementation("com.github.Jaypatelbond.CountryPicker:compose:v1.1.1")

    // For Views / Fragments
    implementation("com.github.Jaypatelbond.CountryPicker:view:v1.1.1")
    
    // Core (Data only)
    implementation("com.github.Jaypatelbond.CountryPicker:core:v1.1.1")
}
```
